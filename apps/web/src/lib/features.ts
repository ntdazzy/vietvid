...
export const CONTENT_GROUPS: FeatureGroup[] = [
  {
    ...
    items: [
      { key: "lookbook", label: "Lookbook Thời trang", desc: "KOL mặc SP bối cảnh editorial", icon: Shirt, available: true, href: "/app/create?feature=lookbook" },
      { key: "review", label: "Tạo Video Review", desc: "KOL review SP theo kịch bản", icon: Film, badge: "Viral", available: true, href: "/app/create?feature=review" },
      { key: "product_ad", label: "Quảng cáo sản phẩm", desc: "Biến SP thành video quảng cáo", icon: Megaphone, badge: "Mới", available: true, href: "/app/create?feature=product_ad" },
  ...
  },
  {
    ...
    items: [
      { key: "text_to_video", label: "Văn bản → Video", desc: "Text-to-video (AI tạo khung)", icon: Type, available: true, href: "/app/create?feature=text_to_video" },
      { key: "image_to_video", label: "Video từ hình ảnh", desc: "Image-to-video", icon: ImageIcon, available: true, href: "/app/create?feature=product_ad" },
      { key: "video_remix", label: "Video từ video mẫu", desc: "Video-to-video remix", icon: Video, badge: "Sắp có", available: false, href: "#" },
      { key: "composite", label: "Ghép Video & Hình ảnh", desc: "Ghép nhiều ảnh thành video", icon: Layers, available: true, href: "/app/compose" },
  ...
  },
  {
    title: "Ảnh & Âm thanh",
    items: [
      { key: "seedance", label: "Seedance 2.0", desc: "Video cinematic AI cao cấp", icon: Sparkles, badge: "Nâng cao", available: true, href: "/app/create?feature=product_ad" },
      { key: "ai_image", label: "Tạo ảnh nghệ thuật AI", desc: "Generate ảnh art AI", icon: Palette, available: true, href: "/app/image-gen" },
      { key: "ai_audio", label: "Tạo âm thanh AI", desc: "Văn bản → giọng Việt", icon: AudioLines, available: true, href: "/app/audio" },
